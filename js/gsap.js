...
gsap.to("#ball1", { fill: "green", scale: 1.1, repeat: 7 })
gsap.to("#ball2", { scale: 1.5, repeat: -1, duration: 1 })
gsap.to("#ball3", { fill: "green", scale: 1.1, repeat: 7 })
gsap.to("#ball4", { scale: 1.5, repeat: -1, duration: 1 })
gsap.to("#ball5", { fill: "green", scale: 1.1, repeat: 7 })
gsap.to("#ball6", { scale: 1.5, repeat: -1, duration: 1 })
gsap.to("#rect1", { scale: 2, duration: 4 })
